  ...
  <div id="app" :class="theme">
    <div class="top">
      ...
      <div class="sort-options">
        sort:
        <a
          :class="{ selected: sort == sortPriority }"
          href="#"
          v-on:click="changeSort(sortPriority)"
          >priority</a
        >
        <a
          :class="{ selected: sort == sortSymbol }"
          href="#"
          v-on:click="changeSort(sortSymbol)"
          >symbol</a
        >
        <a
          :class="{ selected: sort == sortFreshness }"
          href="#"
          v-on:click="changeSort(sortFreshness)"
          >freshness</a
        >
        <a
          :class="{ selected: sort == sortPercentChange }"
          href="#"
          v-on:click="changeSort(sortPercentChange)"
          >% change</a
        >
        <a
          :class="{ selected: sort == sortAbsolutePercentChange }"
          href="#"
          v-on:click="changeSort(sortAbsolutePercentChange)"
          >% ch abs</a
        >
      </div>
      <div class="toggles">
        toggles:
        <a
          :class="{ selected: !showCandles }"
          href="#"
          v-on:click="showCandles = false"
          >daily</a
        >
        <a
          :class="{ selected: showCandles }"
          href="#"
          v-on:click="showCandles = true"
          >candles</a
        >
      </div>
      ...
      <div>
        links:
        <a href="https://money.cnn.com/data/fear-and-greed/" target="blank"
          >f&g index</a
        >
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    visible() {
      const showing = _.filter(this.symbols, (s) => {
        if (this.showCandles) {
          return s.has_candles;
        }
        return true;
      });
      if (this.tag) {
        return _.filter(showing, (s) => {
